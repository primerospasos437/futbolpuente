-- Anotarse: ON CONFLICT debe coincidir con el índice único por grupo
-- (convocatorias_grupo_dia_fecha_jugador = grupo_id, dia, fecha_partido, jugador_id).
-- Antes usaba (dia, fecha_partido, jugador_id) y fallaba con:
